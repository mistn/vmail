  ...
  return (
    ...
    <div>
      <div className="max-w-[1400px] ">
        <p className="mt-8">
          Welcome to Mail.6st.cc.cd! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          Mail.6st.cc.cd is a minimalistic temporary email service that allows you to
          ...
          Mail.6st.cc.cd operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that Mail.6st.cc.cd is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to Mail.6st.cc.cd and its services
          belong to Mail.6st.cc.cd. You may not copy, reproduce, distribute, modify,
          or create derivative works of Mail.6st.cc.cd or any part thereof without
          explicit permission from Mail.6st.cc.cd.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use Mail.6st.cc.cd. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using Mail.6st.cc.cd, you agree not to
        ...
        <p className="mt-4">
          Mail.6st.cc.cd is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of Mail.6st.cc.cd is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall Mail.6st.cc.cd or
          ...
          from your access to or use of Mail.6st.cc.cd or any content or services
          provided through Mail.6st.cc.cd.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of Mail.6st.cc.cd after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where Mail.6st.cc.cd is located. Any disputes
