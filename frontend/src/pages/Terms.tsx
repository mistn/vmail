  ...
  return (
    ...
    <div>
      <div className="max-w-[1400px] ">
        <p className="mt-8">
          Welcome to mail.2731515.xyz! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          mail.2731515.xyz is a minimalistic temporary email service that allows you to
          ...
          mail.2731515.xyz operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that mail.2731515.xyz is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to mail.2731515.xyz and its services
          belong to mail.2731515.xyz. You may not copy, reproduce, distribute, modify,
          or create derivative works of mail.2731515.xyz or any part thereof without
          explicit permission from mail.2731515.xyz.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use mail.2731515.xyz. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using mail.2731515.xyz, you agree not to
        ...
        <p className="mt-4">
          mail.2731515.xyz is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of mail.2731515.xyz is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall mail.2731515.xyz or
          ...
          from your access to or use of mail.2731515.xyz or any content or services
          provided through mail.2731515.xyz.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of mail.2731515.xyz after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where mail.2731515.xyz is located. Any disputes
